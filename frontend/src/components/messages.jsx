        ...
        <div className="mt-auto px-5 py-3">
          <form noValidate="" className="py-1 border rounded-2">
            <div className="input-group has-validation">
              <input name="body" aria-label="Новое сообщение" placeholder={t('messages.inputMessage')} className="border-0 p-0 ps-2 form-control" value={message} onChange={inputHandler}/>
              <button type="submit" disabled={isLoading} onClick={submitHandler} className="btn btn-group-vertical">
